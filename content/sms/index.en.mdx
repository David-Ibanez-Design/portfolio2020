...
<ArticleOverview>
    ...
    <Role>
        <ul>
            <li>Feature specification in collaboration with the product manager</li>
            <li>UI design</li>
        </ul>   
    </Role>    
</ArticleOverview>
...
<Images name={props.images.md["centered-documentation"] } captions="Documenting new UI components in our dedicated site, helped imporve implementation time by reducing guesswork."/>
...
<div className={props.style.containedMd}>
    ...
    <figcaption className={props.style.caption}>"The final version of the SMS creation screen.</figcaption>
</div>
