---
title: Increasing Prospect Reach And Engagement With Two-Way SMS. JAPANESE
...
<ArticleOverview>
    <Sunnary>
        ...
        In order to fufuill that mission, the product needed to provide users with a more efficient way to communication with their prospects that the exsiting emails and calls channels. 
    </Sunnary>
    <Problems>
        Digima customers were already using emails and calls to engage with their prospects, However, many of them found that their email messages and phone calls were left unanswered.     
    </Problems>
    <Goals>
        We need to provide our customers with a way to increase their prospects’ engagement and conversion rates. 
    </Goals>
    <Outcomes>  
        <ul>
...
#### User Flow
## Laying out the feature’s user flow allowed the team and I to identify where we needed to focus our effort and spend most of our time.
...
<p>Building a user flow, allow the team and I to lay down the entire feature functionalities in detail. In addition to getting everybody on the same page, It also allowed us to quickly identify potential issues and iterate upon possible solutions. </p>

<Images 
    className="bg-gray-0" 
    containerType="full" 
    containerWidth="Xl" 
    captions="Building a user flow was instrumental in developping a shared understanding of the overall feature functionalites and challanges."
    name={props.xl["full-User-flow"]}
/>
...
<Images 
    ...
    containerType="full" 
    containerWidth="Xl"
    name={[props.md["centered-Creation-screen-iteration-1"], props.md["centered-Creation-screen-iteration-2"], props.md["centered-Creation-screen-iteration-3"]]}
/>
...
<Images name={props.md["wireframe-creation-screen"]} captions="The final wireframe version for the SMS creation screen."/>
...
<p>
Continuing my strategy of focusing my time and effort on the most challenging functionalities first, I started by creating high fidelity mockups for the SMS creation screens and the chats functionality.
</p>
...
<Images name={props.md["centered-documentation"] } captions="Documented new UI components in our dedicated site, helped imporve implementation time by reducing guesswork."/>

<Images name={props.md["full-Final-design-01"]} captions="The final version of the SMS creation screen."/>
<Images name={props.md["full-Final-design-02"]} captions="The final version of the SMS chat list screen."/>

<!---<Images name={props.md["full-Final-design-03"]}/>--->
...
<Images containerWidth="XXl" name={props.xxl["centered-Prototype-2"]}/>
