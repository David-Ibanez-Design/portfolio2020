...
<ArticleOverview>
    <Sunnary>
        80% of Japanese real estate leads come through portal sites like SUUMO and HOMES, yet Digima had no way to capture them automatically. Our users were inputing every lead by hand, losing crucial context in the process, and falling behind competitors whose CRMs handled this natively. Closing this gap was both an immediate productivity fix for users and a competitive necessity for the product.
    </Sunnary>
    <Problems>
        <ul>
    ...
    <Outcomes>
        <ul>
            ...
            <li>25% increase in the number of leads for accounts subscribed to the new portal to lead feature which has a direct impact on the user's bottom line</li>
        </ul>   
    </Outcomes> 
    <Role>
        <ul>
...
<p>
To remedy that situation, it was decided that a feature allowing users to automatically import leads from all major real estate portal sites into Digima will be built.
</p>
...
<p>
In addition to the prototype used during testing a high fidelity prototype was also created to help the development and business teams understand how the final version of the design will look and behave as a whole.
</p>
...
<li><b>For the business: </b>25% more leads translated directly into revenue, since each lead has a measurable conversion value, an impact the leadership team could point to in funding decisions for the next product cycle.</li>
