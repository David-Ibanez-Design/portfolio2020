...
<ArticleOverview>
    ...
    <Problems>
        <ul>
            <li>Lots of manual work required to add portal site leads into Digima</li>
...
#### Challenges
## Identify potential challenges was essential so that along with insights from user research, they could be used to inform any future design solution.
