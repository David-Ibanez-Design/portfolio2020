...
To that end, I worked in collaboration with the support team to collect any previously reported profile related issues. 
</p>
<p>
To dig deeper into the identified issues, I also participated in several user interviews.
</p>
...
<Images 
    ...
    captions="The journey map allow me to represent user pain points visually and see where we needed to focus our attention."
/>
...
<p>
To facilitate implementation, I broke down each element into components that I then documented <Link to={"/articles/design-system"}>in our existing design system documentation website.</Link>
</p>
