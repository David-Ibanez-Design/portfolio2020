...
<Images name={props.images.md["exsiting-sections-break-down"]} captions="Listing each UI element of the page by order of importance helped me to undestand their overall hierarchical value."/>
...
<Images name={props.images.md["youtrack-tasks"]} captions="Each elements of the redesign were broken down into a user story and spreadout into multiple sprints."/>
