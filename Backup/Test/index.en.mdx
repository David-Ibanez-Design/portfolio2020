---
title: "How We Redesigned A CRM Most Valuable Page, To Improve User Experience And Accelerate New Feature Design."
...
<Images name={props.md["exsiting-UX-issues"]} captions="A few examples of the exsitig page issues."/>
...
<Images name={props.md["exsiting-customer-feedbacks"]} captions="Customer feedbacks also highlighted the need for imporvements"/>
</section>
...
<Images name={props.md["exsiting-google-analytics"]} captions="Google Analytics's data clearly underscore the importance of the contact profile page for our users."/>
</section>
...
<Images name={props.md["exsiting-customer-feedback-spreadsheet"]} captions="Collecting and categorizing all reported issues into a single document helped me find commum solutions for similar issues"/>
</section>
...
<Images name={props.md["exsiting-sections-break-down"]} captions="Listing each UI element of the page by order of importance allowed me to undestand their overall hierarchical value."/>
...
<Images 
    ...
    className="bg-gray-0" 
    containerWidth="Lg"
    name={[props.lg["new-layout-hierarchy-1"], props.lg["new-layout-hierarchy-2"]]}
/>
...
<Images 
    ...
    name={[props.lg["new-sketches-wireframes-1"], props.lg["new-sketches-wireframes-2"]]}
/>
</section>
...
<Images name={props.md["dds-components"]} captions="Each page element were documentaed in our dedicated deisgn system documentation website."/>
...
<Images name={props.md["youtrack-tasks"]} captions="Each elements of the redesign were broken down into user story and spreadout into multiple sprints."/>
...
<Images name={props.md["release-schedule"]} captions="Progressivly exposing users to the new design allow us to minimize disruption to their daily work."/>
...
<ImageSlider beforeKey={props.md["final-version-1"]} afterKey={props.md["final-version-2"]} captions="Before and after versions of the contact profile page."/>

<Images name={props.md["final-version-3"]} captions="Responsive versions of the new profile design."/>
</section>
</div>